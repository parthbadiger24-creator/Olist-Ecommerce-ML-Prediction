...
# ── Configuration ────────────────────────────────────────────────────
# We use relative paths dynamically resolved from __file__ to ensure the 
# script reliably executes whether it's located locally, on OneDrive, or Google Drive.
